<x-admin-layout title="Sửa Thể Loại">
    <style>
        ...
        .btn-submit { background: #d97706; color: white; border: none; padding: 12px 24px; border-radius: 8px; font-weight: 600; cursor: pointer; transition: 0.2s; width: 100%; margin-top: 10px;}
    ...
    <div class="hdr">
        <h2 style="margin: 0; font-size: 1.25rem; font-weight: 600; color: #1e293b;">Cập Nhật Thể Loại</h2>
    </div>
    ...
    <div class="crd">
        ...
        <form action="{{ route('admin.theloai.update', $theloai->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" name="ten_the_loai" class="form-control" value="{{ $theloai->ten_the_loai }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select name="status" class="form-control">
                    ...
                    <option value="0" {{ $theloai->status == 0 ? 'selected' : '' }}>Ẩn / Xóa mềm</option>
                </select>
            </div>
